...
public class DataListRecyclerAdapter extends
  RecyclerView.Adapter<DataListRecyclerAdapter.DataViewHolder> {
  ...
  public void onBindViewHolder(DataViewHolder holder, int position) {
    ...
    double percentage = 100.0 * Integer.parseInt(dataModel.getTotalDeaths()) / Integer
      .parseInt(dataModel.getConfirmedCases());
    @SuppressLint("DefaultLocale") String percentageText =
      "• Fatality Rate: " + String.format("%2.02f", percentage) + "%";
